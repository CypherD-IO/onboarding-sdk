...
import { bridgePopup } from "../utils/bridgePopup";
...
export const noBalanceHTML2 = (parent: any, totalHoldings: any, showInfoScreen: boolean) => {
  ...
  console.log('tokenAvailable List : ', tokensAvailableList);

  // const parentDiv = document.createElement('div');
  // parentDiv.innerHTML = tokensAvailableList;
  // console.log('tokenDetail', tokenDetail);


  // const updatedTokensAvailableList = div.innerHTML;
  ...
  <div class="w-[100%] max-h-[60%] flex flex-col justify-center items-center">
    ...
    <div id="tokens-available-flex-box" class="w-[90%] lg:w-[80%] mt-2 lg:mt-0">
      <table class="w-[100%]" id="tokens-list-table">
        ${tokensAvailableList}
      </table>
    </div>
  ...
  parent.innerHTML = htmlValue;
  // const button = document.getElementById('no-balance-button');
  ...
  //     button.addEventListener('click', () => {
  //       bridgePopup(_.omit(totalHoldings[index], ['about']));
  //     });
  //   });
  // }

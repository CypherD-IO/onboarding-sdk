...
export const bridgeLoading = (parentElement = document.getElementById("popupBackground")) => {
  const bridgeLoadingHTML = `
    <div id="bridge-loading-container" class="maximize-onclick flex flex-col rounded-[30px] bg-primaryBg pt-[25px] w-[90%] lg:w-[30%]">
      <div class="flex flex-row maximize-onclick justify-end items-center w-full px-[20px]">
      ...
      <div class="flex flex-1 flex-col maximize-onclick justify-center self-center items-center px-[30px] w-[72%]">
          ...
          <img class="maximize-onclick mt-[5px]" src="https://public.cypherd.io/icons/logos/loading.gif" alt="loading gif" width="300" height="300">
      </div>
      ${footer()}
    </div>`;

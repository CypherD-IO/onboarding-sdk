...
'<div class="flex flex-col justify-evenly items-center w-[90%] lg:w-[35%] m-auto bg-primaryBg rounded-[30px]">'+
  ...
  '<div class=" flex flex-row justify-center items-center w-[100%] mt-[50px]">'+
    '<button id="bridge-submit-blue-button" disabled class="blue-button disabled-button bg-[#2081E2] text-[16px] font-semibold border-none text-white py-4 w-[60%] rounded-[3px]" onclick="onBridgeClick()">Exchange</button>'+
  '</div>'+

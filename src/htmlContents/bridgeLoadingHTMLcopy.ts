...
<div onclick="maximizeWindow()" id="bridgeLoadingContainer" class="flex flex-col rounded-[30px] bg-primaryBg pt-[25px] w-[90%] lg:w-[30%]">
      ...
      <div class="flex flex-1 flex-col justify-center self-center items-center px-[30px] w-[72%]">
          <h2 class="text-[40px] lg:text-[20px] text-primaryText text-center font-semibold mt-[40px]">Transaction submitted</h2>
          <p class="text-[32px] lg:text-[16px] text-primaryText text-center mt-[10px]">Your transaction is being processed. This can take upto 5 mins</p>

            ...
            <div class="bg-primaryBg rounded-[30px] z-50 flex flex-col justify-between items-center m-auto w-[90%] lg:w-[30%]" id="bridge-popup-css">
              <div class=" bg-primaryBg rounded-t-[30px] p-5 flex flex-col justify-center items-center w-full h-full">
                ...
                <div class="flex justify-evenly w-full items-center">
                  <div class="rounded-full flex items-center justify-center h-[40px] w-[40px] lg:h-[40px] lg:w-[40px] bg-white cursor-pointer" id="bp-max-button" onclick="onMax()">
                ...
                <div class="bg-primaryBg border border-[#E4E4E4] p-2 flex rounded-2xl w-[90%] lg:w-[75%] mt-6">
                  <img src="${globalThis.exchangingTokenDetail.logoUrl}" alt="${globalThis.exchangingTokenDetail.logoUrl}"
              ...
              <div id="bp-submit-button-container" class="bg-primaryBg py-5 lg:py-10 w-full flex items-center justify-center rounded-b-[30px]">
                <button class="bg-[#2081E2] w-[60%] py-4 rounded-lg text-white text-[16px] font-semibold" onclick="bridgeSubmitConditionCheck(globalThis.exchangingTokenDetail.chainDetails.chain_id, globalThis.exchangingTokenDetail.chainDetails.backendName)">Submit</button>
              </div>
